...
from svc_platform.schemas import Parameters

ParametersType = TypeVar('ParametersType', bound=Parameters)


class RoutersFactory(Generic[ParametersType]):
    def __init__(self, parameters_type: Type[ParametersType]):
    ...
    def create(
        ...
        if include_start_router:
            ...
            async def start(start_parameters: ParametersType | None = None) -> dict:
        ...
        async def process(data: engine_io_schemas.process_input_data,
